...
public class ServicePersonne {
	...
	public List<EntityGenreMusic> addAllGenreToDB(){
		...
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson1);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson2);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson3);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson4);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson5);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson6);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson7);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson8);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson9);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson10);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson11);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson12);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson13);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson14);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson15);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson16);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson17);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson18);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson19);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson20);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson21);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson22);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson23);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson24);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson25);
		client.getDatabase("db").getCollection("EntityGenreMusic").insertOne(docJson26);
